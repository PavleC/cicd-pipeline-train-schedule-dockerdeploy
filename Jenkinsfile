pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            ...
            steps {
                script {
                    app = docker.build("pavlecvetkovic/train-schedule")
                    app.inside {
        ...
        stage('DeployToProduction') {
            ...
            steps {
                ...
                milestone(1)
                withCredentials([usernamePassword(credentialsId: '97de5bfc-5c17-4514-aef9-1dea22df05a2', usernameVariable: 'USERNAME', passwordVariable: 'USERPASS')]) {
                    script {
